...
This workshop environment includes Open WebUI, which supports MCP servers. Let's connect it to your MCP server.

1. Click on the **Open WebUI** tab in your workshop environment

2. Navigate to **Admin Settings** (gear icon) → **Settings** → **Tools**

3. Under **MCP Servers**, click **Add MCP Server** and configure:
   - **Name**: `support-assistant`
   - **URL**: `http://localhost:8080/mcp`

4. Save the configuration

5. Start a new chat and verify that the tools appear. Ask a question like:
   ```
   What time is it in Tokyo?
   ```

   Open WebUI will use the MCP protocol to call your `getCurrentDateTime` tool and return the result.

6. Try creating a ticket:
   ```
   Create a high priority technical ticket about database connection issues
   ```

You've now connected an external AI interface to your Spring AI MCP server!-->
